// *********************************************** 
// NAME             : SJPCycleParkImporter.cs      
// AUTHOR           : Amit Patel
// DATE CREATED     : 20 Apr 2011
// DESCRIPTION  	: DataGateway import task to import SJP venue cycle parks data
// ************************************************
...
{
    /// <summary>
    /// DataGateway import task to import SJP venue cycle parks data
    /// </summary>
    public class SJPCycleParkImporter : DatasourceImportTask
    {
        #region Private Fields
        private const string propertyKey = "datagateway.sqlimport.SJPCycleParkLocations.Name";
        private const string propertyFeedName = "datagateway.sqlimport.SJPCycleParkLocations.feedname";
		private string importPropertyName = string.Empty;				
		private const string logDescription = "SJP Cycle Park Import" ;
