// *********************************************** 
// NAME             : SJPGNATLocationsDataImporter.cs      
// AUTHOR           : Mitesh Modi
// DATE CREATED     : 24 Nov 2011
// DESCRIPTION  	: DataGateway import task to import SJP GNAT admin areas
// ************************************************
...
{
    /// <summary>
    /// DataGateway import task to import SJP GNAT admin areas
    /// </summary>
    public class SJPGNATAdminAreasDataImporter : DatasourceImportTask
    {
        #region Private Fields

        private string importPropertyName = string.Empty;
        private const string propertyKey = "datagateway.sqlimport.SJPGNATAdminAreasData.Name";
        private const string propertyFeedName = "datagateway.sqlimport.SJPGNATAdminAreasData.feedname";
        
        private const string logDescription = "SJP GNAT AdminAreas Import";
        ...
        public SJPGNATAdminAreasDataImporter
