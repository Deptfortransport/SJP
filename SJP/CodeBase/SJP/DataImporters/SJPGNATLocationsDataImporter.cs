...
// DESCRIPTION  	: DataGateway import task to import SJP GNAT locations
// ************************************************
...
namespace SJP.DataImporters
{
    ...
    /// </summary>
    public class SJPGNATLocationsDataImporter : DatasourceImportTask
    {
        #region Private Fields
        private const string propertyKey = "datagateway.sqlimport.SJPGNATLocationsData.Name";
        private const string propertyFeedName = "datagateway.sqlimport.SJPGNATLocationsData.feedname";
        private string importPropertyName = string.Empty;
        private const string logDescription = "SJP GNAT Locations Import";
        ...
        public SJPGNATLocationsDataImporter
        ...
        private bool Convert()
        {
            ...
            try
            {
                ...
                using (XmlCsvReader CsvXmlConverter = new XmlCsvReader(myImportFileName, xmlDoc.NameTable))
                {
                    ...
                    AddAttributeToXmlDoc(xmlDoc, xmlNameSpace, (string)Properties.Current["datagateway.sqlimport.SJPGNATLocationsData.xmlnamespace"]);

                    // Now appending namespace:xsi attribute 		
                    AddAttributeToXmlDoc(xmlDoc, xmlNamespaceXs, (string)Properties.Current["datagateway.sqlimport.SJPGNATLocationsData.xmlnamespacexsi"]);
