// *********************************************** 
// NAME             : SJPVenueAccessDataImporter.cs      
// AUTHOR           : Mark Turner
// DATE CREATED     : 16 Jun 2011
// DESCRIPTION  	: DataGateway import task to import SJP venue access data
// ************************************************
...
{
    /// <summary>
    /// DataGateway import task to import SJP venue access data
    /// </summary>
    public class SJPVenueAccessDataImporter : DatasourceImportTask
    {
        #region Private Fields
        private const string propertyKey = "datagateway.sqlimport.SJPVenueAccessData.Name";
        private const string propertyFeedName = "datagateway.sqlimport.SJPVenueAccessData.feedname";
        private string importPropertyName = string.Empty;
        private const string logDescription = "SJP Venue Access Data Import";
        ...
        public SJPVenueAccessDataImporter
