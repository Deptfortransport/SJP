// *********************************************** 
// NAME             : SJPVenueGateDataImporter.cs      
// AUTHOR           : Mark Turner
// DATE CREATED     : 10 May 2011
// DESCRIPTION  	: DataGateway import task to import SJP venue gate data
// ************************************************
...
{
    /// <summary>
    /// DataGateway import task to import SJP venue gate data
    /// </summary>
    public class SJPVenueGateDataImporter : DatasourceImportTask
    {
        #region Private Fields
        private const string propertyKey = "datagateway.sqlimport.SJPVenueGateData.Name";
        private const string propertyFeedName = "datagateway.sqlimport.SJPVenueGateData.feedname";
        private string importPropertyName = string.Empty;
        private const string logDescription = "SJP Venue Gate Data Import";
        ...
        public SJPVenueGateDataImporter
