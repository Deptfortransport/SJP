// *********************************************** 
// NAME             : SJPMobileInitialisation.cs      
// AUTHOR           : Mitesh Modi
// DATE CREATED     : 06 Feb 2012
// DESCRIPTION  	: SJPMobileInitialisation class for initialising services needed for the SJPMobile project
// ************************************************
// 
...
{
    /// <summary>
    /// SJPMobile Initialisation class
    /// </summary>
    public class SJPMobileInitialisation : IServiceInitialisation
    {
        ...
        public void Populate(Dictionary<string, IServiceFactory> serviceCache)
        {
            ...
            Logger.Write(new OperationalEvent(SJPEventCategory.Infrastructure, SJPTraceLevel.Info, "INITIALISATION Started SJPMobileInitialisation"));
            ...
            // UndergroundNews
            Logger.Write(new OperationalEvent(SJPEventCategory.Infrastructure, SJPTraceLevel.Verbose, "INITIALISATION Adding to service cache: UndergroundNewsHandler"));
            ...
            Logger.Write(new OperationalEvent(SJPEventCategory.Infrastructure, SJPTraceLevel.Info, "INITIALISATION Completed SJPMobileInitialisation"));
        }
