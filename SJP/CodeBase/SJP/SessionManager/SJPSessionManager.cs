// *********************************************** 
// NAME             : SJPSessionManager.cs      
// AUTHOR           : Mitesh Modi
// DATE CREATED     : 10 Mar 2011
// DESCRIPTION  	: SJPSessionManager. The session manager allows web pages
...
{
    /// <summary>
    /// SJPSessionManager class
    /// </summary>
    public class SJPSessionManager : ISJPSessionManager, IDisposable
    {
        ...
        /// </summary>
        private SJPSession sjpSession = new SJPSession();
        ...
        /// <summary>
        /// Constructor for the SJPSessionManager that is used through the ServiceDiscovery
        /// </summary>
        /// <param name="sessFactory">The session factory to be used</param>
        public SJPSessionManager(ISJPSessionFactory sessFactory)
        {
