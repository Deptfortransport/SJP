// *********************************************** 
// NAME             : SJPStopEventRequestManager.cs      
// AUTHOR           : Mitesh Modi
// DATE CREATED     : 26 Apr 2011
// DESCRIPTION  	: SJPStopEventRequestManager class to hold multiple stop event requests for a session.
// The class uses the hash property of the request as the key to ensure "identical" requests do not fill
// the historical requests made. This allows the SJPStopEventResultManager to serve the already planned
...
{
    /// <summary>
    /// SJPStopEventRequestManager class to hold multiple stop event requests for a session
    /// </summary>
    [Serializable()]
    public class SJPStopEventRequestManager : ISJPSessionAware
    {
        ...
        /// Constructor
        /// </summary>
        public SJPStopEventRequestManager()
        {
