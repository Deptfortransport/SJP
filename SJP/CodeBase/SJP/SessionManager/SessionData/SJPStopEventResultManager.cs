// *********************************************** 
// NAME             : SJPStopEventResultManager.cs      
// AUTHOR           : Mitesh Modi
// DATE CREATED     : 26 Apr 2011
// DESCRIPTION  	: SJPStopEventResultManager class to hold multiple stop event journey results for a session.
...
{
    /// <summary>
    /// SJPStopEventResultManager class to hold multiple journey results for a session
    /// </summary>
    [Serializable()]
    public class SJPStopEventResultManager : ISJPSessionAware
    {
        ...
        /// Constructor
        /// </summary>
        public SJPStopEventResultManager()
        {
