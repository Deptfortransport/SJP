...
namespace SJP.TestProject.DataImporters
{
    ...
    /// <summary>
    ///This is a test class for SJPCycleParkImporterTest and is intended
    ///to contain all SJPCycleParkImporterTest Unit Tests
    ///</summary>
    [TestClass()]
    public class SJPCycleParkImporterTest
    {
        ...
        /// <summary>
        ///A test for SJPCycleParkImporter Constructor
        ///</summary>
        [TestMethod()]
        public void SJPCycleParkImporterConstructorTest()
        {
            ...
            SJPCycleParkImporter target = new SJPCycleParkImporter(feed, params1, params2, utility, processingDirectory);
            int actual =  target.Run(cyclefeed);
            Assert.AreEqual(0, actual);
        }

        /// <summary>
        ///A test for SJPCycleParkImporter Constructor with wrong feed name and file name
        ///</summary>
        [TestMethod()]
        public void SJPCycleParkImporterConstructorTestWrongFileAndFeed()
        {
