...
namespace SJP.TestProject.DataImporters
{
    ...
    /// <summary>
    ///This is a test class for SJPParkAndRideLocationsImporterTest and is intended
    ///to contain all SJPParkAndRideLocationsImporterTest Unit Tests
    ///</summary>
    [TestClass()]
    public class SJPParkAndRideLocationsImporterTest
    {
        ...
        /// <summary>
        ///A test for SJPParkAndRideLocationsImporter Constructor
        ///</summary>
        [TestMethod()]
        public void SJPParkAndRideLocationsImporterConstructorTest()
        {
            ...
            SJPParkAndRideLocationsImporter target = new SJPParkAndRideLocationsImporter(feed, params1, params2, utility, processingDirectory);
            int actual = target.Run(carparkfeed);
            Assert.AreEqual(0, actual);
        }

        /// <summary>
        ///A test for SJPParkAndRideLocationsImporter Constructor with wrong feed name and file name
        ///</summary>
        [TestMethod()]
        public void SJPParkAndRideLocationsImporterConstructorTestWrongFileAndFeed()
        {
