...
namespace SJP.TestProject.DataImporters
{
    ...
    /// <summary>
    ///This is a test class for SJPVenueAccessDataImporterTest and is intended
    ///to contain all SJPVenueAccessDataImporterTest Unit Tests
    ///</summary>
    [TestClass()]
    public class SJPVenueAccessDataImporterTest
    {
        ...
        /// <summary>
        ///A test for SJPVenueAccessDataImporter Constructor
        ///</summary>
        [TestMethod()]
        public void SJPVenueAccessDataImporterConstructorTest()
        {
            ...
            SJPVenueAccessDataImporter target = new SJPVenueAccessDataImporter(feed, params1, params2, utility, processingDirectory);
            int actual = target.Run(venueAccessDatafeed);
            Assert.AreEqual(0, actual);
        }

        /// <summary>
        ///A test for SJPVenueAccessDataImporter Constructor with wrong feed name and file name
        ///</summary>
        [TestMethod()]
        public void SJPVenueAccessDataImporterConstructorTestWrongFileAndFeed()
        {
        ...
        ///</summary>
        [TestMethod()]
        public void SJPVenueAccessDataImporterConstructorTestNoFeedfile()
        {
