...
namespace SJP.TestProject.DataImporters
{
    ...
    /// <summary>
    ///This is a test class for SJPVenueAdditionalDataImporterTest and is intended
    ///to contain all SJPVenueAdditionalDataImporterTest Unit Tests
    ///</summary>
    [TestClass()]
    public class SJPVenueAdditionalDataImporterTest
    {
        ...
        /// <summary>
        ///A test for SJPVenueAdditionalDataImporter Constructor
        ///</summary>
        [TestMethod()]
        public void SJPVenueAdditionalDataImporterConstructorTest()
        {
            ...
            SJPVenueAdditionalDataImporter target = new SJPVenueAdditionalDataImporter(feed, params1, params2, utility, processingDirectory);
            int actual = target.Run(venueAdditionalDatafeed);
            Assert.AreEqual(0, actual);
        }

        /// <summary>
        ///A test for SJPVenueAdditionalDataImporter Constructor with wrong feed name and file name
        ///</summary>
        [TestMethod()]
        public void SJPVenueAdditionalDataImporterConstructorTestWrongFileAndFeed()
        {
