...
namespace SJP.TestProject.DataImporters
{
    ...
    /// <summary>
    ///This is a test class for SJPVenueGateDataImporterTest and is intended
    ///to contain all SJPVenueGateDataImporterTest Unit Tests
    ///</summary>
    [TestClass()]
    public class SJPVenueGateDataImporterTest
    {
        ...
        /// <summary>
        ///A test for SJPVenueGateDataImporter Constructor
        ///</summary>
        [TestMethod()]
        public void SJPVenueGateDataImporterConstructorTest()
        {
            ...
            SJPVenueGateDataImporter target = new SJPVenueGateDataImporter(feed, params1, params2, utility, processingDirectory);
            int actual = target.Run(venueGateDatafeed);
            Assert.AreEqual(0, actual);
        }

        /// <summary>
        ///A test for SJPVenueGateDataImporter Constructor with wrong feed name and file name
        ///</summary>
        [TestMethod()]
        public void SJPVenueGateDataImporterConstructorTestWrongFileAndFeed()
        {
